      ...
      <form method="POST" align="center">
         ...
         <table class="display" id="example">
            ...
            <div class="form-inline">
               <textarea name="ccs" id="down"  class="btn btn-success" placeholder="Digite o IP" rows="1" class="form-control" style="cursor: auto; width: 250px; height: 40px;text-align: center;" placeholder=""></textarea>
               <div class="form-inline">
                  <button type="submit" value="Iniciar " onclick="start()" class="fcbtn btn btn-warning btn-outline btn-1e btn-squared">Pesquisar</button>
         </table>
         </div>
      </form>
      <!-- Copyright -->
